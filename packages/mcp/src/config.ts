...
Examples:
  ...
  OPENAI_API_KEY=sk-xxx MILVUS_ADDRESS=localhost:19530 node ~/.claude-context/packages/mcp/dist/index.js
  
  # Start MCP server with OpenAI and specific model
  OPENAI_API_KEY=sk-xxx EMBEDDING_MODEL=text-embedding-3-large MILVUS_TOKEN=your-token node ~/.claude-context/packages/mcp/dist/index.js
  
  # Start MCP server with VoyageAI and specific model
  EMBEDDING_PROVIDER=VoyageAI VOYAGEAI_API_KEY=pa-xxx EMBEDDING_MODEL=voyage-3-large MILVUS_TOKEN=your-token node ~/.claude-context/packages/mcp/dist/index.js
  
  # Start MCP server with Gemini and specific model
  EMBEDDING_PROVIDER=Gemini GEMINI_API_KEY=xxx EMBEDDING_MODEL=gemini-embedding-001 MILVUS_TOKEN=your-token node ~/.claude-context/packages/mcp/dist/index.js
  
  # Start MCP server with Ollama and specific model (using OLLAMA_MODEL)
  EMBEDDING_PROVIDER=Ollama OLLAMA_MODEL=mxbai-embed-large MILVUS_TOKEN=your-token node ~/.claude-context/packages/mcp/dist/index.js
  
  # Start MCP server with Ollama and specific model (using EMBEDDING_MODEL)
  EMBEDDING_PROVIDER=Ollama EMBEDDING_MODEL=nomic-embed-text MILVUS_TOKEN=your-token node ~/.claude-context/packages/mcp/dist/index.js

  # Start MCP server with a human-readable collection name override
  OPENAI_API_KEY=sk-xxx MILVUS_TOKEN=your-token CODE_CHUNKS_COLLECTION_NAME_OVERRIDE=my_project node ~/.claude-context/packages/mcp/dist/index.js

  # Start MCP server with background sync enabled every minute
  OPENAI_API_KEY=sk-xxx MILVUS_TOKEN=your-token CLAUDE_CONTEXT_BACKGROUND_SYNC=true CLAUDE_CONTEXT_SYNC_INTERVAL_MS=60000 node ~/.claude-context/packages/mcp/dist/index.js
        `);
}
